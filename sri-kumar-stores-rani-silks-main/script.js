...
function openCheckoutCustomerModal() {
    ...
    console.log(
        "[DEBUG] openCheckoutCustomerModal() called"
    );
    ...
    console.log(
        "[DEBUG] modal active class added, current className:",
        modal.className
    );

    modal.dataset.openedAt =
        Date.now().toString();
...
function closeCheckoutCustomerModal() {
    ...
    console.trace(
        "[DEBUG] closeCheckoutCustomerModal() called - see stack below"
    );
...
function setupCheckout() {
    ...
    checkoutButton.addEventListener(
        ...
        event => {
            ...
            console.log(
                "[DEBUG] checkoutBtn click received"
            );
...
async function initializeTextel() {
    ...
    console.log(
        "Sri Kumar Stores website initializing... [checkout-fix-v3-debug]"
    );
